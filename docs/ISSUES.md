...
| I-16 | OPEN | Kyverno `malaby-restricted` (Audit): frontends/mongo still run as root → need non-root nginx images + mongo UID 999/readOnlyRootFS | Phase 9 follow-up | agent |
