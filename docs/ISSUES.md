...
| I-13 | OPEN | **Shared Jenkins is down** (`jenkins-0` Error; init `cp` loop; STS 0/1) → Phase 6 CI cannot run | Blocks Phase 6 verification and CI-based Phases 7/8 | operator (CR-1) |
