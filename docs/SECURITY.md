...
| C5 | Rate limiting (login/write/api) + `trust proxy` | F5 | middleware; CI logs no `ERR_ERL_*` |
...
| C15 | Dual-booking prevented at DB level (partial unique index) + whole-day overlap | correctness | `docs/BUGFIXES.md` B1 |
