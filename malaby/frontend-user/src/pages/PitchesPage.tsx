    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">الملاعب</h1>
          <p className="text-gray-500">اكتشف مجموعتنا المتنوعة من الملاعب واختر ما يناسبك</p>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pr-10 pl-4 py-3 rounded-lg border border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none"
              />
            </div>
            ...
            {hasFilters && (
              <button
                ...
                className="flex items-center gap-2 px-5 py-3 rounded-lg border border-red-200 text-red-600 hover:bg-red-50 font-medium transition-colors"
              >
                <X className="h-4 w-4" />
                مسح
              </button>
